...
const LandingContent = () => {
  ...
  // Activar la animación después de que el componente se monta
  useEffect(() => {
    // Esto asegura que la clase se aplique después de montar el componente
  ...
  return (
    <div className="landing-content flex flex-col items-center justify-center h-[calc(100vh-5.5rem)] w-full text-center bg-black bg-cover bg-center">
      <section className="landing-section min-w-[65.875rem] min-h-[36.464rem] rounded-[1.5rem] flex flex-col items-center justify-center border-[0.125rem] border-custom-gray-dark bg-[radial-gradient(circle,transparent_20%,#0a0a0a_90%),radial-gradient(#1e1e1e_12%_13%,transparent_14%)] bg-[100%_100%,14px_14px]">
        ...
        <h1 className="landing-h1 font-bold text-[4rem] tracking-widest mb-4">
